...
FREQ_DIST_FILE = 'dataset/logistic/train-processed-freqdist.pkl'
BI_FREQ_DIST_FILE = 'dataset/logistic/train-processed-freqdist-bi.pkl'
TRAIN_PROCESSED_FILE = 'dataset/logistic/train-processed.csv'
TEST_PROCESSED_FILE = 'dataset/logistic/test-processed.csv'
TRAIN = True
UNIGRAM_SIZE = 15000
