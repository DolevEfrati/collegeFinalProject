...
FREQ_DIST_FILE = '../dataset/training.processed.noemoticon-processed-freqdist.pkl'
BI_FREQ_DIST_FILE = '../dataset/training.processed.noemoticon-processed-freqdist-bi.pkl'
TRAIN_PROCESSED_FILE = '../dataset/training.processed.noemoticon-processed.csv'
TEST_PROCESSED_FILE = '../dataset/testing.processed.noemoticon-processed.csv'
TRAIN = True
UNIGRAM_SIZE = 15000
